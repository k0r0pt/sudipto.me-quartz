    ...
    <>
      {node.file ? (
        ...
        <li key={node.file.slug}>
          <a className={"explorerNodeLink"} href={resolveRelative(fileData.slug!, node.file.slug!)} data-for={node.file.slug}>
            {node.displayName}
          </a>
        </li>
      ) : (
          ...
          {node.name !== "" && (
            ...
            <div class="folder-container">
              ...
              <div key={node.name} data-folderpath={folderPath}>
                {folderBehavior === "link" ? (
                  <a className={"explorerNodeLink"} href={href} data-for={node.name} class="folder-title">
                    {node.displayName}
                  </a>
                ) : (
